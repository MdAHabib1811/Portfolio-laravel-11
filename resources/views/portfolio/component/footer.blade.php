    ...
    <div class="container">
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{url('service')}}"><span class="fa fa-chevron-right mr-2"></span>Services</a></li>
                        <li><a href="{{url('project')}}"><span class="fa fa-chevron-right mr-2"></span>Projects</a></li>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Developed by <a href="https://www.ussbd.com/" target="_blank">Unicorn Software Solutions</a>
                </p>
                </div>
            </div>
        </div>
